...
<!-- start first report code line from here  -->
    <!-- <div class="row"> -->
      ...
      <div class="row" style="padding: 10px;"> 
        ...
        $conn = connectMyDB();
        $sql = "SELECT * FROM introductiondetails";
...
<div class="container-fluid">
    ...
    // include('../db_connection.php');
        $conn = connectMyDB();
        $sql = "SELECT * FROM permanentaddress";
        $result = mysqli_query($conn, $sql);
        if (mysqli_num_rows($result) > 0) {
        $i=1;
        while($row = mysqli_fetch_assoc($result)){
...
?> 
   ...
   <!--end fourth table code line from here  -->
    ...
    // include('../db_connection.php');
        $conn = connectMyDB();
        $sql = "SELECT * FROM `languagedetails`";
        $result = mysqli_query($conn, $sql);
        if (mysqli_num_rows($result) > 0) {
        $i=1;
        while($row = mysqli_fetch_assoc($result)){
...
?> 
    ...
    // include('../db_connection.php');
        $conn = connectMyDB();
        $sql = "SELECT * FROM `servicetimedetails`";
        $result = mysqli_query($conn, $sql);
        $i=1;
        while($row = mysqli_fetch_assoc($result)){
       ?>
